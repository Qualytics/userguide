...
!!! note 
    For more information, please refer to the [Anomaly Types](types.md) Documentation.
...
!!! note
    For more information, please refer to the [Anomaly Detection Process](detection.md) Documentation.