...
!!! note 
    For more information, please refer to the [Adding a Source Datastore](../source-datastore/add-datastores/connections/new-connection.md){:target="_blank"} documentation.
...
!!! note 
    For more information, please refer to the documentation [Anomalies Overview](overview.md).