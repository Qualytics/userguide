...
| Step | What Happens |
|------|----------------|
| 1 | You connect [Atlan](../settings/integrations/data-catalogs/atlan.md), [Alation](../settings/integrations/data-catalogs/alation.md), or another supported catalog to Qualytics under **Settings → Integrations**. |
