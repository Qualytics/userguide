...
![datastore](../assets/data-quality-checks/inferred-check/datastore.png)

**Step 2:** Click on the **"Checks"** tab from the Navigation Tab.

![checks](../assets/data-quality-checks/inferred-check/checks.png)
...
To understand how Inferred checks work, you can follow the steps from the documentation [**Profile Operation.**](../source-datastore/operations/profile.md)

After the profiling run is complete, inferred checks will be automatically created based on the analysis of your data.

![profiling](../assets/data-quality-checks/inferred-check/profiling.png)
...
![check-summary](../assets/data-quality-checks/inferred-check/check-summary.png)

**Check ID**: A unique identifier assigned to this particular check.

![check-id](../assets/data-quality-checks/inferred-check/check-id.png)

**Check Type**: Indicates the nature of the validation being performed on the check.

![check-type](../assets/data-quality-checks/inferred-check/check-type.png)
...
![warnings](../assets/data-quality-checks/inferred-check/warnings.png)
...
![open-details](../assets/data-quality-checks/inferred-check/open-details.png)

**Check Actions**: Opens a dropdown menu with more actions related to managing or modifying the check.

![check-actions](../assets/data-quality-checks/inferred-check/check-actions.png)
...
![target](../assets/data-quality-checks/inferred-check/target.png)

**3. Fields List**: Displays the fields that are expected to be present in the dataset.

![fields](../assets/data-quality-checks/inferred-check/fields.png)
...
![allow-fields](../assets/data-quality-checks/inferred-check/allow-fields.png)
...
![description](../assets/data-quality-checks/inferred-check/description.png)
...
![tags](../assets/data-quality-checks/inferred-check/tags.png)
...
![additional-metadata](../assets/data-quality-checks/inferred-check/additional-metadata.png)

Enter the desired key-value pairs. After entering the necessary metadata, click **"Confirm"** to save the custom metadata.

![confirm-button](../assets/data-quality-checks/inferred-check/confirm-button.png)
...
![validate-button](../assets/data-quality-checks/inferred-check/validate-button.png)

If the validation is successful, a green message will appear saying **"Validation Successful"**.

![validation-successful](../assets/data-quality-checks/inferred-check/validation-successful.png)

**Step 5**: Once you have a successful validation, click the **"Update"** button.

![update-button](../assets/data-quality-checks/inferred-check/update-button.png)
...
![successfully-updated](../assets/data-quality-checks/inferred-check/successfully-updated.png)

## Inference Engine

1. After metadata is generated by a [**Profile Operation**](../source-datastore/operations/profile.md), Inference Engine is initiated to kick off Inductive and Unsupervised learning methods.  
