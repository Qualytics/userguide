...
For more details on Inferred Checks, please refer to the [**Inferred Check**](../data-quality-checks/inferred-check.md) documentation.
...
For more details on Authored Checks, please refer to the [**Authored Checks**](../data-quality-checks/authored-check.md) documentation.
...
![datastore](../assets/data-quality-checks/overview-of-a-check/edit.png)
...
![datastore](../assets/data-quality-checks/overview-of-a-check/datastores.png)

**Step 2:** Click the **"Checks"** from the navigation tab.

![tab](../assets/data-quality-checks/overview-of-a-check/tab.png)

You will see a list of all the checks that have been applied to the selected datastore.

![selected-datastore](../assets/data-quality-checks/overview-of-a-check/selected-datastore.png)

You can switch between different types of checks to view them categorically (such as All, Active, Draft, and Archived).

![categorically](../assets/data-quality-checks/overview-of-a-check/categorically.png)

### Method 2: Explore Section

**Step 1:** Log in to your Qualytics account and click the **Explore** button on the left side panel of the interface.

![explore-tab](../assets/data-quality-checks/overview-of-a-check/explore.png)

**Step 2:** Click the **"Checks"** from the navigation tab.

![checks](../assets/data-quality-checks/overview-of-a-check/checks.png)
...
![list](../assets/data-quality-checks/overview-of-a-check/list.png)
...
For more details about check templates, please refer to the [**Check Templates**](../data-quality-checks/checks-template.md) documentation.
...
For more details on how to apply check templates for quality checks, please refer to the [**Apply Check Template for Quality Checks**](../data-quality-checks/apply-check-template-for-quality-checks.md) documentation.
...
For more details about export check templates, please refer to the [**Export Check Templates**](../data-quality-checks/export-check-templates.md) documentation.
...
For more details about check rule types, please refer to the [**Rule Types Overview**](../data-quality-checks/rule-types-overview.md) documentation.
...
| [Before Date Time](../data-quality-checks/before-date-time-check.md)                                | Asserts that the field is a timestamp earlier than a specific date and time.                       |
...
| [Max Partition Size](../data-quality-checks/max-partition-size-check.md)                                             | Asserts the maximum number of records that should be loaded from each file or table partition.                                                           |
