...
| [**Operation Completes**](../flows/trigger-node.md#operation-completes){target="_blank"} | Starts the Flow when a sync, scan, or profile operation finishes. |
...
![flow](../assets/flows/flow-entry/flow.png)
