...
![manual-flow](../assets/flows/manage-flow/execute-manual-flows/manual-flow.png)
...
![manual-flow](../assets/flows/manage-flow/execute-manual-flows/vertical.png)
...
![manual-flow](../assets/flows/manage-flow/execute-manual-flows/manual-list.png)

**Step 2:** You will be navigated to the Flow editor page; click the **Execute** button.

![manual-flow](../assets/flows/manage-flow/execute-manual-flows/execute-manual.png)
