...
![notification](../assets/flows/actions-node/http/http.png)
...
![notification](../assets/flows/actions-node/http/http-4.png)
...
![test](../assets/flows/actions-node/http/test.png)

**Step 3:** Once you have entered all the values, then click on the **Save** button.

![save](../assets/flows/actions-node/http/save.png)
...
![notification](../assets/flows/actions-node/http/http-5.png)
...
![notification](../assets/flows/actions-node/http/http-6.png)
...
![notification](../assets/flows/actions-node/http/http-7.png)
...
![test](../assets/flows/actions-node/http/test-2.png)
...
![publish](../assets/flows/actions-node/http/publish.png)
