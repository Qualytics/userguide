...
![trigger](../assets/flows/trigger-node/trigger.png)
...
![triggersetting](../assets/flows/trigger-node/trigger-setting.png)
...
![hourly](../assets/flows/trigger-node/hourly.png)
...
![daily](../assets/flows/trigger-node/daily.png)
...
![weekly](../assets/flows/trigger-node/weekly.png)
...
![monthly](../assets/flows/trigger-node/monthly.png)
...
![advanced](../assets/flows/trigger-node/advanced.png)

## Operation Completes

This type of flow is triggered whenever an operation, such as a sync, profile, or scan, is completed on a source datastore. Upon completion, teams are promptly notified through in-app messages and, if configured, via external notification channels such as email, Slack, Microsoft Teams, and others. For example, the team is notified whenever the sync operation is completed, helping them proceed with the profile operation on the datastore.

![operation](../assets/flows/trigger-node/operation.png)
...
![operation](../assets/flows/trigger-node/operation-2.png)

Once the conditions are set, click the **Save** button to finalize the trigger configuration.

![save](../assets/flows/trigger-node/save.png)
...
![table](../assets/flows/trigger-node/table.png)
...
![table](../assets/flows/trigger-node/table-2.png)
...
![anomaly](../assets/flows/trigger-node/anomaly.png)
...
![anomaly](../assets/flows/trigger-node/anomaly-2.png)
...
![anomaly-status-changed](../assets/flows/trigger-node/anomaly-status-changed.png)
...
![anomaly-status-number](../assets/flows/trigger-node/anomaly-status-number.png)
...
![manual](../assets/flows/trigger-node/manual.png)
...
![filter-tooltip](../assets/flows/trigger-node/filter-tooltip.png)
