...
![notification](../assets/flows/actions-node/notification/notification.png)
...
![notification](../assets/flows/actions-node/notification/notification-2.png)

A panel **In App Settings** will appear on the right-hand side, allowing you to configure the notification message.

![notification](../assets/flows/actions-node/notification/notification-3.png)
...
![notification](../assets/flows/actions-node/notification/notification-4.png)
...
![save](../assets/flows/actions-node/notification/save.png)
...
![notification](../assets/flows/actions-node/notification/notification-5.png)
...
![notification](../assets/flows/actions-node/notification/notification-6.png)
...
![notification](../assets/flows/actions-node/notification/notification-7.png)
...
![test](../assets/flows/actions-node/notification/test.png)
...
![click-slack](../assets/flows/actions-node/notification/click-slack.png)

A **Slack Settings** panel appears on the right side of the screen.

![slack-settings](../assets/flows/actions-node/notification/slack-settings.png)
...
![slack-options](../assets/flows/actions-node/notification/slack-options.png)

**Step 2:** Click the **Test Notification** button to send a sample notification to the selected Slack channel.

![test-notification](../assets/flows/actions-node/notification/test-notification.png)

A prompt appears stating **Notification successfully sent** once the notification is successfully delivered.

![successfully-notified](../assets/flows/actions-node/notification/successfully-notified.png)
...
![anomaly-detected](../assets/flows/actions-node/notification/anomaly-detected.png)
...
![scan-completed](../assets/flows/actions-node/notification/scan-completed.png)
...
![anomalous-scan](../assets/flows/actions-node/notification/anomalous-scan.png)
...
![view-operation](../assets/flows/actions-node/notification/view-operation.png)
...
![view-results](../assets/flows/actions-node/notification/view-results.png)
...
![view-anomaly](../assets/flows/actions-node/notification/view-anomaly.png)

* **Acknowledge** – Click on Acknowledge to mark it as reviewed to avoid duplicate alerts.  

![acknowledge-anomaly](../assets/flows/actions-node/notification/acknowledge-anomaly.png)  

* **Horizontal ellipsis(⋯)**  – Click on horizontal ellipsis.

![horizontal-ellipsis](../assets/flows/actions-node/notification/horizontal-ellipsis.png)

  A dropdown will open with option **comment** and **archive** :  

![comment-archive](../assets/flows/actions-node/notification/comment-archive.png)
...
![notification](../assets/flows/actions-node/notification/notification-8.png)
...
![notification](../assets/flows/actions-node/notification/notification-9.png)
...
![notification](../assets/flows/actions-node/notification/notification-10.png)
...
![notification](../assets/flows/actions-node/notification/notification-11.png)
...
![notification](../assets/flows/actions-node/notification/notification-12.png)

**Integration Key:** Enter the **Integration Key** where you want the notification to be sent.

![notification](../assets/flows/actions-node/notification/notification-13.png)
...
![notification](../assets/flows/actions-node/notification/notification-14.png)

**Message:** Enter your custom message using variables in the Message field, where you can specify the content of the notification that will be sent out.

![notification](../assets/flows/actions-node/notification/notification-15.png)
