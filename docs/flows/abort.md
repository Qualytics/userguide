...
![chart](../assets/flows/manage-flow/abort/abort-setting.png)

**Step 2:** Click on the **abort** to stop the execution.

![chart](../assets/flows/manage-flow/abort/abort.png)
...
![chart](../assets/flows/manage-flow/abort/abort-icon.png)
...
![chart](../assets/flows/manage-flow/abort/hover-abort.png)
...
![chart](../assets/flows/manage-flow/abort/abort-bulk.png)

**Step 2:** Click on the vertical ellipsis (⋮), and select the **Abort** option from the action toolbar.

![chart](../assets/flows/manage-flow/abort/abort-action.png)

A confirmation prompt appears. Click **Abort** to confirm the action.

![chart](../assets/flows/manage-flow/abort/abort-confirm.png)
