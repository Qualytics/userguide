...
![add-datastore](../../assets/source-datastores/datastore-settings/settings-overview/add-datastore-1.png)
...
![settings](../../assets/source-datastores/datastore-settings/settings-overview/settings-2.png)

## Edit Datastore

Use the **Edit Datastore** option to make changes to your datastore’s connection setup whenever updates are needed.

For more information on how to edit the datastore, please refer to the [Edit Datastore](edit-datastore.md) documentation.
...
For more information on how to link an enrichment datastore, please refer to the [Link Enrichment](link-enrichment.md) documentation.
...
For more information on the quality score, please refer to the [Quality Score](quality-score-settings.md) documentation.
...
For more information on how to delete a datastore, please refer to the [Delete Datastore](delete-datastore.md) documentation.