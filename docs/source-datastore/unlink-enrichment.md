...
![enrichment-settings](../assets/source-datastores/datastore-settings/unlink-enrichment/enrichment-settings.png)
...
![unlink-option](../assets/source-datastores/datastore-settings/unlink-enrichment/unlink-option.png)

A modal window titled **Unlink Enrichment Datastore** will appear.

![unlink-window](../assets/source-datastores/datastore-settings/unlink-enrichment/unlink-window.png)

**Step 3:** Click the **Unlink** button to remove the enrichment datastore connection.

![unlink](../assets/source-datastores/datastore-settings/unlink-enrichment/unlink.png)
