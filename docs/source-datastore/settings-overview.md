...
![add-datastore](../assets/source-datastores/datastore-settings/settings-overview/add-datastore-light-1.png)
...
![settings](../assets/source-datastores/datastore-settings/settings-overview/settings-light-2.png)
