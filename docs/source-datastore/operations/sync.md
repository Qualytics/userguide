...
![initiate-sync-checkbox](../../assets/source-datastores/operations/sync/step-1-initiate-sync-checkbox.png)
...
![sync-running-automatically](../../assets/source-datastores/operations/sync/step-2-sync-running-automatically.png)
...
![select-source-datastore](../../assets/source-datastores/operations/sync/select-source-datastore.png)
...
![sync-button-overview](../../assets/source-datastores/operations/sync/step-3-sync-button-overview.png)
...
![operation-triggered](../../assets/source-datastores/operations/sync/step-4-operation-triggered.png)
...
![sync-completed-containers](../../assets/source-datastores/operations/sync/step-5-sync-completed-containers.png)
...
![sync-error-aborted](../../assets/source-datastores/operations/sync/step-90-sync-error-aborted.png)
-->
...
![run-dropdown-sync](../../assets/source-datastores/operations/sync/step-6-run-dropdown-sync.png)
...
![sync-settings-prune-recreate](../../assets/source-datastores/operations/sync/step-7-sync-settings-prune-recreate.png)
...
![sync-settings-include](../../assets/source-datastores/operations/sync/step-8-sync-settings-include.png)

### Run Instantly

Click on the "**Run Now**" button to perform the sync operation immediately.

![run-now-button](../../assets/source-datastores/operations/sync/step-9-run-now-button.png)
...
![schedule-button](../../assets/source-datastores/operations/sync/step-10-schedule-button.png)
...
![schedule-hourly](../../assets/source-datastores/operations/sync/step-11-schedule-hourly.png)
...
![schedule-daily](../../assets/source-datastores/operations/sync/step-12-schedule-daily.png)
...
![schedule-weekly](../../assets/source-datastores/operations/sync/step-13-schedule-weekly.png)
...
![schedule-monthly](../../assets/source-datastores/operations/sync/step-14-schedule-monthly.png)
...
![schedule-advanced](../../assets/source-datastores/operations/sync/step-15-schedule-advanced.png)

**Step 3**: Define the **"Schedule Name"** to identify the scheduled operation at run time.

![schedule-name](../../assets/source-datastores/operations/sync/step-16-schedule-name.png)

**Step 4:** Click on the **"Schedule"** button to activate your sync operation schedule.

![schedule-confirm-button](../../assets/source-datastores/operations/sync/step-17-schedule-confirm-button.png)

After clicking **Schedule**, a confirmation message appears stating **"Operation Scheduled"**.

![operation-scheduled](../../assets/source-datastores/operations/sync/step-18-operation-scheduled.png)
...
![sync-completed-activity](../../assets/source-datastores/operations/sync/step-19-sync-completed-activity.png)
...
![activity-top-panel](../../assets/source-datastores/operations/sync/step-20-activity-top-panel.png)
...
![activity-heatmap](../../assets/source-datastores/operations/sync/step-21-activity-heatmap.png)
...
![operation-status-running](../../assets/source-datastores/operations/sync/step-22-operation-status-running.png)
...
![operation-status-aborted](../../assets/source-datastores/operations/sync/step-23-operation-status-aborted.png)
...
![operation-status-warning](../../assets/source-datastores/operations/sync/step-24-operation-status-warning.png)
...
![operation-status-success](../../assets/source-datastores/operations/sync/step-25-operation-status-success.png)
...
![post-sync-container-names](../../assets/source-datastores/operations/sync/step-26-post-sync-container-names.png)
...
![post-sync-container-fields](../../assets/source-datastores/operations/sync/step-27-post-sync-container-fields.png)
...
![post-sync-table-settings](../../assets/source-datastores/operations/sync/step-28-post-sync-table-settings.png)
