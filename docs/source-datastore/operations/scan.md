...
![side-menu](../../assets/source-datastores/operations/scan/side-menu.png)
...
![details-page](../../assets/source-datastores/operations/scan/details-page.png)
...
![run](../../assets/source-datastores/operations/scan/run.png)
...
![all-operation](../../assets/source-datastores/operations/scan/all-operation.png)
...
![specific](../../assets/source-datastores/operations/scan/specific.png)
...
![tag](../../assets/source-datastores/operations/scan/tag.png)

**Step 3:** Click on the **Next** button to Configure **Select Check Categories**.

![next](../../assets/source-datastores/operations/scan/next.png)
...
![select-check](../../assets/source-datastores/operations/scan/select-check.png)

**Step 5:** Click on the **Next** button to Configure the **Read Settings**.

![next](../../assets/source-datastores/operations/scan/nextt.png)
...
![incremental](../../assets/source-datastores/operations/scan/incremental.png)
...
![starting-threshold](../../assets/source-datastores/operations/scan/starting-threshold.png)
...
![record-limit-line](../../assets/source-datastores/operations/scan/record-limit-line.png)
 ...
 ![record-limit-options](../../assets/source-datastores/operations/scan/record-limit-options.png)
...
![next-button](../../assets/source-datastores/operations/scan/next-button.png)
...
![anomaly-option](../../assets/source-datastores/operations/scan/anomaly-option.png)
...
![anomaly-option](../../assets/source-datastores/operations/scan/anomalyy.png)
...
![source-record-limit](../../assets/source-datastores/operations/scan/source-record-limit.png)
...
![record-limit](../../assets/source-datastores/operations/scan/record-limit.png)

## Run Instantly

Click on the **Run Now** button to perform the scan operation immediately.

![run-now](../../assets/source-datastores/operations/scan/run-now.png)

## Schedule

**Step 1:** Click on the **Schedule** button to configure the available schedule options for your scan operation.

![click-schedule](../../assets/source-datastores/operations/scan/click-schedule.png)
...
![hourly](../../assets/source-datastores/operations/scan/hourly.png)
...
![daily](../../assets/source-datastores/operations/scan/daily.png)
...
![weekly](../../assets/source-datastores/operations/scan/weekly.png)
...
![monthly](../../assets/source-datastores/operations/scan/monthly.png)
...
![advanced](../../assets/source-datastores/operations/scan/advanced.png)

**Step 3:** Define the **Schedule Name** to identify the scheduled operation at the running time.

![schedule-name](../../assets/source-datastores/operations/scan/schedule-name.png)

**Step 4:** Click on the **Schedule** button to schedule your scan operation.

![schedule](../../assets/source-datastores/operations/scan/schedule.png)
...
![activity-operation](../../assets/source-datastores/operations/scan/activity-operation.png)
...
![activity](../../assets/source-datastores/operations/scan/activity.png)
...
![running](../../assets/source-datastores/operations/scan/running.png)
...
![aborted-operation](../../assets/source-datastores/operations/scan/aborted-operation.png)
...
![warning](../../assets/source-datastores/operations/scan/warning.png)
...
![success](../../assets/source-datastores/operations/scan/success-2.png)
...
![records-scan-operation](../../assets/source-datastores/operations/scan/records-scan-operation.png)

#### Post Operation Details

**Step 1:** Click on any of the successful **Scan Operations** from the list and hit the **Results** button.

![result-scan-operation](../../assets/source-datastores/operations/scan/result-scan-operation.png)
...
![result](../../assets/source-datastores/operations/scan/result.png)
...
![drop-down](../../assets/source-datastores/operations/scan/drop-down.png)
