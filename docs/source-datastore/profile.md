...
![adding-source-datastore](../assets/source-datastores/profile/adding-source-datastore.png)
...
![profile](../assets/source-datastores/profile/profile.png)

## Configuration

**Step 1**: Click on the **Run** button to initiate the profile operation.

![run-profile](../assets/source-datastores/profile/run-profile.png)
...
![profile-operation-all](../assets/source-datastores/profile/profile-operation-all.png)
...
![profile-operation-specific](../assets/source-datastores/profile/profile-operation-specific.png)
...
![profile-operation-tag](../assets/source-datastores/profile/profile-operation-tag.png)
  
**Step 3**: After making the relevant selections, click on the **Next** button to configure the **Operation Settings**.

![profile-operation-next](../assets/source-datastores/profile/profile-operation-next.png)
...
![starting-threshold](../assets/source-datastores/profile/starting-threshold.png)
...
![record-limit](../assets/source-datastores/profile/record-limit.png)

You can also use a drop-down menu to quickly select from commonly used limits such as 1M, 10M, 100M, and All.

![record-dropdown](../assets/source-datastores/profile/record-dropdown.png)
...
![next](../assets/source-datastores/profile/next.png)
...
![default-configuration](../assets/source-datastores/profile/default-configuration.png)
...
![inference-threshold-level0](../assets/source-datastores/profile/inference-threshold-level0.png)
...
![inference-threshold-level1](../assets/source-datastores/profile/inference-threshold-level1.png)
...
![inference-threshold-level2](../assets/source-datastores/profile/inference-threshold-level2.png)
...
![inference-threshold-level3](../assets/source-datastores/profile/inference-threshold-level3.png)
...
![inference-threshold-level4](../assets/source-datastores/profile/inference-threshold-level4.png)
...
![inference-threshold-level5](../assets/source-datastores/profile/inference-threshold-level5.png)
...
![hourly](../assets/source-datastores/profile/hourly.png)
...
![daily](../assets/source-datastores/profile/daily.png)
...
![weekly](../assets/source-datastores/profile/weekly.png)
...
![monthly](../assets/source-datastores/profile/monthly.png)
...
![advanced](../assets/source-datastores/profile/advanced.png)
  
**Step 3**: Define the **Schedule Name** to identify the scheduled operation at the running time.

![schedule-name](../assets/source-datastores/profile/schedule-name.png)

**Step 4**: Click on the **Schedule** button to activate your profile operation schedule.

![profile-operation-schedule](../assets/source-datastores/profile/profile-operation-schedule.png)
...
![activity-fields](../assets/source-datastores/profile/activity-fields.png)
...
![activity-table](../assets/source-datastores/profile/activity-table.png)
...
![profile-running](../assets/source-datastores/profile/profile-running.png)
...
![profile-aborted](../assets/source-datastores/profile/profile-aborted.png)
...
![profile-warning](../assets/source-datastores/profile/profile-warning.png)
...
![profile-success](../assets/source-datastores/profile/profile-success.png)
...
![records-profiled-operation](../assets/source-datastores/profile/profile-scan-operation.png)

## Post Operation Details

**Step 1**: Click on any of the successful **Profile Operations** from the list and hit the Results button.

![profile-result](../assets/source-datastores/profile/profile-result.png)
...
![profiled](../assets/source-datastores/profile/profiled.png)
...
![view-table](../assets/source-datastores/profile/view-table.png)
...
![sandbox-tpch](../assets/source-datastores/profile/sandbox-tpch.png)
...
![total-anomalies](../assets/source-datastores/profile/total-anomalies.png)
...
![total-profile](../assets/source-datastores/profile/totals-profile.png)
...
![histogram](../assets/source-datastores/profile/histogram.png)
