...
![configure-qualytics-node-pool](../../assets/source-datastores/add-datastores/databricks/configure-qualytics-node-pool.png)
...
![connection-details-for-sql-warehouse](../../assets/source-datastores/add-datastores/databricks/connection-details-for-sql-warehouse.png)
...
![connection-details-for-the-cluster](../../assets/source-datastores/add-datastores/databricks/connection-details-for-the-cluster.png)
...
![user-settings](../../assets/source-datastores/add-datastores/databricks/user-settings.png)
...
![developer-option](../../assets/source-datastores/add-datastores/databricks/developer-options.png)

**Step 3:** In the **Developer** page, click on **Manage** in Access Tokens.

![manage-access-token](../../assets/source-datastores/add-datastores/databricks/manage-access-token.png)

**Step 4:** In the **Access Tokens** page, click on the **Generate new token** button.

![generate-new-token](../../assets/source-datastores/add-datastores/databricks/generate-new-token.png)

**Step 5:** You will see a modal to add a description and validation time (in days) for the token.

![add-a-description](../../assets/source-datastores/add-datastores/databricks/add-a-description.png)

**Step 6:** After adding the contents, click on **Generate**, and it will show the **token**.

![generated-token](../../assets/source-datastores/add-datastores/databricks/generated-token.png)
...
![new-token](../../assets/source-datastores/add-datastores/databricks/new-token.png)

You can also revoke a **token** on the **Access Tokens** page by clicking on the **Revoke token** button.

![revoke-token](../../assets/source-datastores/add-datastores/databricks/revoke-token.png)
...
![add-datastore](../../assets/source-datastores/add-datastores/databricks/add-datastore.png)

**Step 2:** A modal window - **Add Datastore** will appear, providing you with the options to connect a datastore.

![select-a-connector](../../assets/source-datastores/add-datastores/databricks/select-a-connector.png)
...
![add-datastore-credentials](../../assets/source-datastores/add-datastores/databricks/add-datastore-credentials.png)
...
![hashcorp-vault](../../assets/source-datastores/add-datastores/databricks/hashcorp.png)

**Step 2:** The configuration form will expand, requesting credential details before establishing the connection.

![add-datastore-credentials-explain](../../assets/source-datastores/add-datastores/databricks/add-datastore-credentials-explain.png)
...
![test-datastore-connection](../../assets/source-datastores/add-datastores/databricks/test-datastore-connection.png)
...
![use-existing-datastore](../../assets/source-datastores/add-datastores/databricks/use-existing-datastore.png)
...
![test-connection-for-existing-datastore](../../assets/source-datastores/add-datastores/databricks/test-connection-for-existing-datastore.png)
...
![next-button-for-enrichment](../../assets/source-datastores/add-datastores/databricks/next-button-for-enrichment.png)

**Step 2:** A modal window - **Link Enrichment Datastore** will appear, providing you with the options to configure an **enrichment datastore**.

![select-enrichment-connector](../../assets/source-datastores/add-datastores/databricks/select-enrichment-connector.png)
...
![caret-button](../../assets/source-datastores/add-datastores/databricks/add-enrichment.png)

A modal window **Link Enrichment Datastore** will appear. Enter the following details to create an enrichment datastore with a new connection.

![modal-window](../../assets/source-datastores/add-datastores/databricks/add-enrichment-detail.png)
...
![enrichment-datastore-explain](../../assets/source-datastores/add-datastores/databricks/enrichment-datastore-explain.png)
...
![secret-management](../../assets/source-datastores/add-datastores/databricks/secret-management.png)

**Step 3:** The configuration form, requesting credential details after selecting **enrichment datastore** connector.

![config-details](../../assets/source-datastores/add-datastores/databricks/config-details.png)
...
![test-connection-for-enrichment-datastore](../../assets/source-datastores/add-datastores/databricks/test-connection-for-enrichment-datastore.png)

**Step 5:** Click on the **Finish** button to complete the configuration process.

![finish-configuration](../../assets/source-datastores/add-datastores/databricks/finish-configuration.png)
...
![data-operation-page](../../assets/source-datastores/add-datastores/databricks/data-operations-page.png)
...
![use-enrichment-datastore](../../assets/source-datastores/add-datastores/databricks/use-enrichment.png)

**Step 2:** A modal window **Link Enrichment Datastore** will appear. Add a prefix name and select an existing enrichment datastore from the dropdown list.

![use-enrichment-details](../../assets/source-datastores/add-datastores/databricks/use-enrichment-details.png)
...
![use-existing-enrichment-datastore](../../assets/source-datastores/add-datastores/databricks/use-existing-enrichment-datastore.png)

**Step 4:** Click on the **Finish** button to complete the configuration process for the existing **enrichment datastore**.

![finish-configuration-for-existing-enrichment-datastore](../../assets/source-datastores/add-datastores/databricks/finish-configuration-for-existing-enrichment-datastore.png)
