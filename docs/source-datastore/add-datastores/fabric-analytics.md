...
![portal-azure](../../assets/source-datastores/add-datastores/fabric/portal-azure.png)

**2.** Click on the **+ New registration** to create and register a new application in Microsoft Entra ID.

![new-registration](../../assets/source-datastores/add-datastores/fabric/new-registration.png)
...
![register-app](../../assets/source-datastores/add-datastores/fabric/qualytics-fabric-integration.png)
...
![certificates-secrets](../../assets/source-datastores/add-datastores/fabric/app-registration-overview.png){: style="height:300px"}

**2.** Copy the **Application (client) ID** — this is your **Client ID**.

![register-app](../../assets/source-datastores/add-datastores/fabric/copy-client-id.png)

**3.** Copy the **Directory (tenant) ID** — this is your **Tenant ID**.

![register-app](../../assets/source-datastores/add-datastores/fabric/copy-tenant-id.png)

### Step 3: Create a Client Secret

**1.** In the app registration, go to **Client secrets** and click **+ New client secret**.

![create-secret](../../assets/source-datastores/add-datastores/fabric/qualytics-fabric-secret.png)

**2.** After clicking **+ New client secret**, enter a description and choose an expiration period.

![create-secret](../../assets/source-datastores/add-datastores/fabric/description.png)

**3.** Copy the **Value** of the newly created secret immediately — this is your **Client Secret** (it will not be shown again).

![create-secret](../../assets/source-datastores/add-datastores/fabric/copy-value.png)
...
![azure-admin-portal](../../assets/source-datastores/add-datastores/fabric/azure-admin-portal.png)
...
![azure-enable-api](../../assets/source-datastores/add-datastores/fabric/azure-enable-api.png)
...
![azure-enable-api](../../assets/source-datastores/add-datastores/fabric/manage-access.png)

**2.** Click **+ Add people or groups**, search for your registered application (e.g., `qualytics-fabric`), and select it.  

![azure-workspace-add-people-or-groups](../../assets/source-datastores/add-datastores/fabric/azure-workspace-add-people-or-groups.png)
...
The endpoint format is:
    ...
    ```
![sql-endpoint](../../assets/source-datastores/add-datastores/fabric/sql-endpoint.png){: style="height:300px"}
...
![add-datastore](../../assets/source-datastores/add-datastores/fabric/add-datastore.png)

**Step 2:** A modal window- **Add Datastore** will appear, providing you with the options to connect a datastore.

![select-a-connector](../../assets/source-datastores/add-datastores/fabric/select-a-connector.png)
...
![add-datastore-credentials](../../assets/source-datastores/add-datastores/fabric/add-datastore-credentials.png)
...
![hashicorp-explain](../../assets/source-datastores/add-datastores/fabric/hashicorp-explain.png)

**Step 2:** The configuration form will expand, requesting credential details before establishing the connection.

![add-datastore-credentials-explain](../../assets/source-datastores/add-datastores/fabric/add-datastore-credentials-explain.png)
...
![test-datastore-connection](../../assets/source-datastores/add-datastores/fabric/test-datastore-connection.png)
...
![test-existing-connection](../../assets/source-datastores/add-datastores/fabric/test-source-datastore.png)
!!! note
...
![next-button-for-enrichment](../../assets/source-datastores/add-datastores/fabric/next-button-for-enrichment.png)

**Step 2:** A modal window **Link Enrichment Datastore** will appear, providing you with the options to configure an **enrichment datastore**.

![select-enrichment-connector](../../assets/source-datastores/add-datastores/fabric/select-enrichment-connector.png)
...
![add-enrichments](../../assets/source-datastores/add-datastores/fabric/add-enrichments.png)

A modal window **Link Enrichment Datastore** will appear. Enter the following details to create an enrichment datastore with a new connection.

![add-enrichment-details](../../assets/source-datastores/add-datastores/fabric/add-enrichment-details.png)
...
![select-enrichment](../../assets/source-datastores/add-datastores/fabric/select-enrichment.png)
...
![test-datastore-connection](../../assets/source-datastores/add-datastores/fabric/test-connection-for-enrichment-datastore.png)

**Step 4:** Click on the **Finish** button to complete the configuration process.

![finish-configuration](../../assets/source-datastores/add-datastores/fabric/finish-configuration.png)
...
![data-operation-page](../../assets/source-datastores/add-datastores/fabric/data-operation-page.png)
...
![use-enrichment](../../assets/source-datastores/add-datastores/fabric/use-enrichment.png)
...
![use-enrichment-datastore](../../assets/source-datastores/add-datastores/fabric/use-enrichment-datastore.png)
...
![select-enrichment-datastore](../../assets/source-datastores/add-datastores/fabric/select-enrichment-datastore.png)

**Step 4:** Click on the **Finish** button to complete the configuration process for the existing **enrichment datastore**.

![click-finish-datastore](../../assets/source-datastores/add-datastores/fabric/click-finish-datastore.png)
