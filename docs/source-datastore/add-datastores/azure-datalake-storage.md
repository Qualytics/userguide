...
![get-azure-datalake-account-credentials](../../assets/source-datastores/add-datastores/azure-datalake-storage/get-azure-datalake-account-credentials.png)
...
![add-datastore](../../assets/source-datastores/add-datastores/azure-datalake-storage/add-datastore.png)

**Step 2**: A modal window - **Add Datastore** will appear, providing you with the options to connect a datastore.

![select-a-connector](../../assets/source-datastores/add-datastores/azure-datalake-storage/select-a-connector.png)
...
![add-datastore-credentials](../../assets/source-datastores/add-datastores/azure-datalake-storage/add-datastore-credentials.png)
...
![secret-management](../../assets/source-datastores/add-datastores/azure-datalake-storage/secret-management-04.png)

**Step 2**: The configuration form will expand, requesting credential details before establishing the connection.

![add-datastore-credentials-explain](../../assets/source-datastores/add-datastores/azure-datalake-storage/add-datastore-credentials-explain.png)
...
![test-datastore-connection](../../assets/source-datastores/add-datastores/azure-datalake-storage/test-datastore-connection.png)
...
![test-connection-for-existing-datastore](../../assets/source-datastores/add-datastores/azure-datalake-storage/test-datastore-connection.png)
...
![next-button-for-enrichment](../../assets/source-datastores/add-datastores/azure-datalake-storage/next-button-for-enrichment.png)

**Step 2**:  A modal window - **Link Enrichment Datastore** will appear, providing you with the options to configure an **enrichment datastore**.

![select-enrichment-connector](../../assets/source-datastores/add-datastores/azure-datalake-storage/select-enrichment-connector.png)
...
![select-enrichment](../../assets/source-datastores/add-datastores/azure-datalake-storage/select-enrichment-10.png)

A modal window - **Link Enrichment Datastore** will appear. Enter the following details to create an enrichment datastore with a new connection.

![enrichment-detail](../../assets/source-datastores/add-datastores/azure-datalake-storage/enrichment-details-11.png)
...
![enrichment-datastore-explain](../../assets/source-datastores/add-datastores/azure-datalake-storage/enrichment-datastore-explain.png)
...
![test-connection-for-enrichment-datastore](../../assets/source-datastores/add-datastores/azure-datalake-storage/test-connection-for-enrichment-datastore.png)

**Step 4**: Click on the **Finish** button to complete the configuration process.

![finish-configuration](../../assets/source-datastores/add-datastores/azure-datalake-storage/finish-configuration.png)

When the configuration process is finished, a modal will display a **success message** indicating that **your datastore has been successfully added**.

![success-message](../../assets/source-datastores/add-datastores/azure-datalake-storage/success-message.png)
...
![data-operation-page](../../assets/source-datastores/add-datastores/azure-datalake-storage/data-operation-page.png)
...
![select-enrichment-details](../../assets/source-datastores/add-datastores/azure-datalake-storage/select-enrichment-17.png)

**Step 2**: A modal window - **Link Enrichment Datastore** will appear. Add a prefix name and select an existing enrichment datastore from the dropdown list.

![add-enrichment-details](../../assets/source-datastores/add-datastores/azure-datalake-storage/add-enrichment-details-18.png)
...
![use-existing-enrichment-datastore](../../assets/source-datastores/add-datastores/azure-datalake-storage/use-existing-enrichment-datastore.png)

**Step 4**: Click on the **Finish** button to complete the configuration process for the existing **enrichment datastore**.

![finish-configuration-for-existing-enrichment-datastore](../../assets/source-datastores/add-datastores/azure-datalake-storage/finish-configuration-for-existing-enrichment-datastore.png)
