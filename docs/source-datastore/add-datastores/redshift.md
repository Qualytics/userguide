...
![add-datastore](../../assets/source-datastores/add-datastores/redshift/add-datastore.png)

**Step 2**: A modal window - **Add Datastore** will appear, providing you with the options to connect a datastore.

![select-a-connector](../../assets/source-datastores/add-datastores/redshift/select-a-connector.png)
...
![add-datastore-credentials](../../assets/source-datastores/add-datastores/redshift/add-datastore-credentials.png)
...
![hashcorp-explain](../../assets/source-datastores/add-datastores/redshift/hashcorp-explain.png)

**Step 2**: The configuration form will expand, requesting credential details before establishing the connection.

![add-datastore-credentials-explain](../../assets/source-datastores/add-datastores/redshift/add-datastore-credentials-explain.png)
...
![test-datastore-connection](../../assets/source-datastores/add-datastores/redshift/test-datastore-connection.png)
...
![use-existing-datastore](../../assets/source-datastores/add-datastores/redshift/use-existing-datastore.png)
...
![test-connection-for-existing-datastore](../../assets/source-datastores/add-datastores/redshift/test-connection-for-existing-datastore.png)
...
![next-button-for-enrichment](../../assets/source-datastores/add-datastores/redshift/next-button-for-enrichment.png)

**Step 2**: A modal window - **Link Enrichment Datastore** will appear, providing you with the options to configure an **enrichment datastore**.

![select-enrichment-connector](../../assets/source-datastores/add-datastores/redshift/select-enrichment-connector.png)
...
![caret-button](../../assets/source-datastores/add-datastores/redshift/add-enrichment.png)

A modal window **Link Enrichment Datastore** will appear. Enter the following details to create an enrichment datastore with a new connection.

![modal-window](../../assets/source-datastores/add-datastores/redshift/add-enrichment-details.png)
...
![modal-window](../../assets/source-datastores/add-datastores/redshift/add-enrichment-detail.png)
...
![secret-management](../../assets/source-datastores/add-datastores/redshift/secret-management.png)

**Step 3:** The configuration form, requesting credential details after selected **enrichment datastore** connector.

![enrichment-datastore-explain](../../assets/source-datastores/add-datastores/redshift/enrichment-datastore-explain.png)
...
![test-connection-for-enrichment-datastore](../../assets/source-datastores/add-datastores/redshift/test-connection-for-enrichment-datastore.png)

**Step 5**: Click on the **Finish** button to complete the configuration process.

![finish-configuration](../../assets/source-datastores/add-datastores/redshift/finish-configuration.png)
...
![data-operation-page](../../assets/source-datastores/add-datastores/redshift/data-operation-page.png)
...
![use-enrichment-datastore](../../assets/source-datastores/add-datastores/redshift/use-enrichment.png)

**Step 2**:  A modal window **Link Enrichment Datastore** will appear. Add a prefix name and select an existing enrichment datastore from the dropdown list.

![select-existing-enrichment-datastore](../../assets/source-datastores/add-datastores/redshift/select-existing-enrichment-datastore.png)
...
![use-existing-enrichment-datastore](../../assets/source-datastores/add-datastores/redshift/use-existing-enrichment-datastore.png)

**Step 4**: Click on the **Finish** button to complete the configuration process for the existing **enrichment datastore**.

![finish-configuration-for-existing-enrichment-datastore](../../assets/source-datastores/add-datastores/redshift/finish-configuration-for-existing-enrichment-datastore.png)
