...
![add-datastore](../../assets/source-datastores/add-datastores/snowflake/add-datastore.png)

**Step 2**: A modal window - **Add Datastore** will appear, providing you with the options to connect a datastore.

![select-a-connector](../../assets/source-datastores/add-datastores/snowflake/select-a-connector.png)
...
![add-datastore-credentials](../../assets/source-datastores/add-datastores/snowflake/add-datastore-credentials.png)
...
![hashcorp-explain](../../assets/source-datastores/add-datastores/snowflake/hashcorp-explain.png)

**Step 2**: The configuration form will expand, requesting credential details before establishing the connection.

![add-datastore-credentials-explain](../../assets/source-datastores/add-datastores/snowflake/add-datastore-credentials-explain-new.png)
...
![test-datastore-connection](../../assets/source-datastores/add-datastores/snowflake/test-datastore-connection.png)
...
![test-connection-for-existing-datastore](../../assets/source-datastores/add-datastores/snowflake/test-connection-for-existing-datastore.png)
...
![next-button-for-enrichment](../../assets/source-datastores/add-datastores/snowflake/next-button-for-enrichment.png)

**Step 2**: A modal window - **Link Enrichment Datastore** will appear, providing you with the options to configure an **enrichment datastore**.

![select-enrichment-connector](../../assets/source-datastores/add-datastores/snowflake/select-enrichment-connector.png)
...
![caret-button](../../assets/source-datastores/add-datastores/snowflake/add-enrichment.png)

A modal window - **Link Enrichment Datastore** will appear. Enter the following details to create an enrichment datastore with a new connection.

![modal-window](../../assets/source-datastores/add-datastores/snowflake/add-enrichment-details.png)
...
![modal-window](../../assets/source-datastores/add-datastores/snowflake/add-enrichment-detail.png)
...
![secret-management](../../assets/source-datastores/add-datastores/snowflake/secret-management.png)

**Step 3:** The configuration form, requesting credential details after selecting the **enrichment datastore** connector.

![enrichment-datastore-explain](../../assets/source-datastores/add-datastores/snowflake/enrichment-datastore-connector-new.png)
...
![test-connection-for-enrichment-datastore](../../assets/source-datastores/add-datastores/snowflake/test-connection-for-enrichment-datastore.png)

**Step 5**: Click on the **Finish** button to complete the configuration process.

![finish-configuration](../../assets/source-datastores/add-datastores/snowflake/finish-configuration.png)
...
![data-operation-page](../../assets/source-datastores/add-datastores/snowflake/data-operation-page.png)
...
![use-enrichment-datastore](../../assets/source-datastores/add-datastores/snowflake/use-enrichment.png)

**Step 2**:  A modal window - **Link Enrichment Datastore** will appear. Add a prefix name and select an existing enrichment datastore from the dropdown list.

![select-existing-enrichment-datastore](../../assets/source-datastores/add-datastores/snowflake/select-existing-enrichment-datastore.png)
...
![use-existing-enrichment-datastore](../../assets/source-datastores/add-datastores/snowflake/use-existing-enrichment-datastore.png)

**Step 4**: Click on the **Finish** button to complete the configuration process for the existing **enrichment datastore**.

![finish-configuration-for-existing-enrichment-datastore](../../assets/source-datastores/add-datastores/snowflake/finish-configuration-for-existing-enrichment-datastore.png)
