...
![add-source-datastore](../../assets/source-datastores/add-datastores/dremio/add-source-datastore-1.png)

**Step 2**: A modal window - **Add Datastore** will appear, providing you with the options to connect a datastore.

![add-source-datastore](../../assets/source-datastores/add-datastores/dremio/add-source-datastore-2.png)
...
![add-source-datastore-details](../../assets/source-datastores/add-datastores/dremio/add-source-datastore-details-3.png)
...
![secret-management](../../assets/source-datastores/add-datastores/dremio/secret-management-04.png)

**Step 2**: The configuration form will expand, requesting credential details before establishing the connection.

![add-configure-details](../../assets/source-datastores/add-datastores/dremio/add-configure-details-4.png)
...
![test-source-connection](../../assets/source-datastores/add-datastores/dremio/test-source-connection-5.png)
...
![test-existing-enrichment-connection](../../assets/source-datastores/add-datastores/dremio/test-existing-enrichment-connection-7.png)
...
![click-source](../../assets/source-datastores/add-datastores/dremio/click-source-8.png)

**Step 2**: A modal window - **Link Enrichment Datastore** will appear, providing you with the options to configure an **enrichment datastore**.

![enrichment-details](../../assets/source-datastores/add-datastores/dremio/enrichment-details-9.png)
...
![select-enrichment](../../assets/source-datastores/add-datastores/dremio/select-enrichment-10.png)

A modal window **Link Enrichment Datastore** will appear. Enter the following details to create an enrichment datastore with a new connection.

![enrichment-detail](../../assets/source-datastores/add-datastores/dremio/enrichment-details-11.png)
...
![add-enrichment-details](../../assets/source-datastores/add-datastores/dremio/add-enrichment-details-12.png)

**Step 3**: Click on the **Test Connection** button to verify the selected enrichment datastore connection. If the connection is verified, a flash message will indicate that the connection with the datastore has been successfully verified.  

![test-enrichment-connection](../../assets/source-datastores/add-datastores/dremio/test-enrichment-connection-13.png)

**Step 4**: Click on the **Finish** button to complete the configuration process.

![enrichment-details-finish](../../assets/source-datastores/add-datastores/dremio/enrichment-details-finish-14.png)
...
![athena-created](../../assets/source-datastores/add-datastores/dremio/dremio-created-16.png)
...
![select-enrichment-details](../../assets/source-datastores/add-datastores/dremio/select-enrichment-17.png)
...
![add-enrichment-details](../../assets/source-datastores/add-datastores/dremio/add-enrichment-details-18.png)
...
![add-existing-enrichment](../../assets/source-datastores/add-datastores/dremio/add-existing-enrichment-19.png)

**Step 4**: Click on the **Finish** button to complete the configuration process for the existing **enrichment datastore**.

![click-finish](../../assets/source-datastores/add-datastores/dremio/click-finish-20.png)

When the configuration process is finished, a modal will display a success message indicating that your datastore has been successfully added.

Close the success message and you will be automatically redirected to the **Source Datastore Details** page where you can perform data operations on your configured **source datastore**.

![athena-existing-created](../../assets/source-datastores/add-datastores/dremio/dremio-created-16.png)
