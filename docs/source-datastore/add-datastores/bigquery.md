...
![google-cloud-platform-page](../../assets/source-datastores/add-datastores/bigquery/google-cloud-platform-page.png)
...
![create-a-dataset](../../assets/source-datastores/add-datastores/bigquery/create-a-dataset.png)
...
![configure-dataset-details](../../assets/source-datastores/add-datastores/bigquery/configure-dataset-details.png){: style=width:650px}

**Step 4:** Click the **Create Dataset** button to apply the configuration and create the dataset.

![create-dataset-button](../../assets/source-datastores/add-datastores/bigquery/create-dataset-button.png){: style=width:650px}

**Step 5:** Navigate to the **created dataset** and find the **Dataset ID** in the **Dataset Info**.

![created-dataset-page](../../assets/source-datastores/add-datastores/bigquery/created-dataset-page.png){: style=width:650px}
...
![add-datastore](../../assets/source-datastores/add-datastores/bigquery/add-datastore.png)

**Step 2:** A modal window - **Add Datastore** will appear, providing you with the options to connect a datastore.

![select-a-connector](../../assets/source-datastores/add-datastores/bigquery/select-a-connector.png)
...
![add-datastore-credentials](../../assets/source-datastores/add-datastores/bigquery/add-datastore-credentials.png)
...
![secrets-management](../../assets/source-datastores/add-datastores/bigquery/secrets-management.png)

**Step 2:** The configuration form, requesting credential details before establishing the connection.

![add-datastore-credentials-explain](../../assets/source-datastores/add-datastores/bigquery/add-datastore-credentials-explain.png)
...
![test-datastore-connection](../../assets/source-datastores/add-datastores/bigquery/test-datastore-connection.png)
...
![test-connection-for-existing-datastore](../../assets/source-datastores/add-datastores/bigquery/test-connection-for-existing-datastore.png)
...
![next-button-for-enrichment](../../assets/source-datastores/add-datastores/bigquery/next-button-for-enrichment.png)

**Step 2:** A modal window - **Link Enrichment Datastore** will appear, providing you with the options to configure an **enrichment datastore**.

![select-enrichment-connector](../../assets/source-datastores/add-datastores/bigquery/select-enrichment-connector.png)
...
![select-enrichment-connector](../../assets/source-datastores/add-datastores/bigquery/add-new.png)

A modal window **Link Enrichment Datastore** will appear. Enter the following details to create an enrichment datastore with a new connection.

![select-enrichment-connector](../../assets/source-datastores/add-datastores/bigquery/new-connection-detail.png)
...
![enrichment-datastore-explain](../../assets/source-datastores/add-datastores/bigquery/new-detailss.png)
...
![hash-details](../../assets/source-datastores/add-datastores/bigquery/hash-details.png)

**Step 3:** The configuration form, requesting credential details after selecting **enrichment datastore** connector.

![connection-details](../../assets/source-datastores/add-datastores/bigquery/connection-detailss.png)
...
![test-connection-for-enrichment-datastore](../../assets/source-datastores/add-datastores/bigquery/test-connection-for-enrichment-datastore.png)

**Step 5:** Click on the **Finish** button to complete the configuration process.

![finish-configuration](../../assets/source-datastores/add-datastores/bigquery/finish-configuration.png)
...
![data-operation-page](../../assets/source-datastores/add-datastores/bigquery/data-operations-page.png)
...
![use-enrichment](../../assets/source-datastores/add-datastores/bigquery/use-enrichment.png)

**Step 2:** A modal window **Link Enrichment Datastore** will appear. Add a prefix name and select an existing enrichment datastore from the dropdown list.

![select-existing-enrichment-datastore](../../assets/source-datastores/add-datastores/bigquery/select-existing-enrichment-datastore.png)
...
![use-existing-enrichment-datastore](../../assets/source-datastores/add-datastores/bigquery/use-existing-enrichment-datastore.png)

**Step 4:** Click on the **Finish** button to complete the configuration process for the existing **enrichment datastore**.

![finish-configuration-for-existing-enrichment-datastore](../../assets/source-datastores/add-datastores/bigquery/finish-configuration-for-existing-enrichment-datastore.png)
...
=== "Create a Source Datastore using the CLI"
    ...
    qualytics connections create \
        --type bigquery \
        --name "your_connection_name" \
        --password ${BIGQUERY_SERVICE_ACCOUNT_KEY}
