...
![add-datastore](../../assets/source-datastores/add-datastores/microsoft-sql-server/add-datastore.png)

**Step 2:** A modal window - **Add Datastore** will appear, providing you with the options to connect a datastore.

![select-a-connector](../../assets/source-datastores/add-datastores/microsoft-sql-server/select-a-connector.png)
...
![add-datastore-credentials](../../assets/source-datastores/add-datastores/microsoft-sql-server/add-datastore-credentials.png)
...
![hashicorp-explain](../../assets/source-datastores/add-datastores/microsoft-sql-server/hashicorp-explain.png)

**Step 2**: The configuration form will expand, requesting credential details before establishing the connection.

![add-datastore-credentials-explain](../../assets/source-datastores/add-datastores/microsoft-sql-server/add-datastore-credentials-explain.png)
...
![test-datastore-connection](../../assets/source-datastores/add-datastores/microsoft-sql-server/test-datastore-connection.png)
...
![use-existing-datastore](../../assets/source-datastores/add-datastores/microsoft-sql-server/use-existing-datastore.png)
...
![test-connection-for-existing-datastore](../../assets/source-datastores/add-datastores/microsoft-sql-server/test-connection-for-existing-datastore.png)
...
![next-button-for-enrichment](../../assets/source-datastores/add-datastores/microsoft-sql-server/next-button-for-enrichment.png)
...
![select-enrichment-connector](../../assets/source-datastores/add-datastores/microsoft-sql-server/select-enrichment-connector.png)
...
![caret-button](../../assets/source-datastores/add-datastores/microsoft-sql-server/add-enrichment.png)

A modal window **Link Enrichment Datastore** will appear. Enter the following details to create an enrichment datastore with a new connection.

![modal-window](../../assets/source-datastores/add-datastores/microsoft-sql-server/add-enrichment-details.png)
...
![modal-window](../../assets/source-datastores/add-datastores/microsoft-sql-server/add-enrichment-detail.png)

**Step 3:** Click on the **Test Connection** button to verify the selected enrichment datastore connection. If the connection is verified, a flash message will indicate that the connection with the datastore has been successfully verified. 

![test-connection-for-enrichment-datastore](../../assets/source-datastores/add-datastores/microsoft-sql-server/test-connection-for-enrichment-datastore.png)

**Step 4:** Click on the **Finish** button to complete the configuration process. 

![finish-configuration](../../assets/source-datastores/add-datastores/microsoft-sql-server/finish-configuration.png)
...
![data-operation-page](../../assets/source-datastores/add-datastores/microsoft-sql-server/data-operation-page.png)
...
![use-enrichment-datastore](../../assets/source-datastores/add-datastores/microsoft-sql-server/use-enrichment.png)

**Step 2:** A modal window **Link Enrichment Datastore** will appear. Add a prefix name and select an existing enrichment datastore from the dropdown list.

![select-existing-enrichment-datastore](../../assets/source-datastores/add-datastores/microsoft-sql-server/select-existing-enrichment-datastore.png)
...
![use-existing-enrichment-datastore](../../assets/source-datastores/add-datastores/microsoft-sql-server/use-existing-enrichment-datastore.png)

**Step 4:** Click on the **Finish** button to complete the configuration process for the existing **enrichment datastore**.

![finish-configuration-for-existing-enrichment-datastore](../../assets/source-datastores/add-datastores/microsoft-sql-server/finish-configuration-for-existing-enrichment-datastore.png)
