...
![add-datastore](../../../assets/source-datastores/add-datastores/connections/add-datastore.png)

**Step 2:** A modal window - **Add Datastore** will appear, providing you with the options to connect a datastore.

![details](../../../assets/source-datastores/add-datastores/connections/details.png)
...
![detail](../../../assets/source-datastores/add-datastores/connections/detail.png)
...
![secret](../../../assets/source-datastores/add-datastores/connections/secret.png)

**Step 4:** The configuration form requests credential details before establishing a connection.

![form](../../../assets/source-datastores/add-datastores/connections/requesting.png)
...
![test](../../../assets/source-datastores/add-datastores/connections/test.png)

If the credentials and provided details are verified, a success message will be displayed indicating that the connection has been verified.

**Step 6:** Once the connection is verified, click the **Finish** button to complete the process.

![finish](../../../assets/source-datastores/add-datastores/connections/finish.png)
...
![msg](../../../assets/source-datastores/add-datastores/connections/msg.png)
...
![add](../../../assets/source-datastores/add-datastores/connections/add-datastore.png)
...
![detail](../../../assets/source-datastores/add-datastores/connections/details-connection.png)
...
![test-connection](../../../assets/source-datastores/add-datastores/connections/test.png)
