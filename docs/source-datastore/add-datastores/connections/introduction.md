...
-   :material-plus-circle:{ .lg .middle } **New Connection**

    ---

    Create a new source datastore by setting up a new connection from scratch with your own credentials.

    [:octicons-arrow-right-24: Setup a Connection](new-connection.md)

-   :material-link-variant:{ .lg .middle } **Existing Connection**

    ---

    Create a new source datastore by reusing credentials from a connection that already exists.
