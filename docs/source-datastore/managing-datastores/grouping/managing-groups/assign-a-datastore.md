...
![assign-icon](../../../../assets/source-datastores/managing-datastores/grouping/managing-groups/assign-a-datastore/assign-icon.png)

**Step 2**: Click the **Assign to group** button. A dropdown will appear with the list of available groups.

![assign-dropdown](../../../../assets/source-datastores/managing-datastores/grouping/managing-groups/assign-a-datastore/assign-dropdown.png)

**Step 3**: Select the group you want to assign the datastore to.

![datastore-assigned](../../../../assets/source-datastores/managing-datastores/grouping/managing-groups/assign-a-datastore/datastore-assigned.png)
...
![datastore-in-group](../../../../assets/source-datastores/managing-datastores/grouping/managing-groups/assign-a-datastore/datastore-in-group.png)
