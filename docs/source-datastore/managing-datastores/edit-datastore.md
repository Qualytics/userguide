...
![edit-datastore](../../assets/source-datastores/managing-datastores/edit-datastore/edit-datastore-3.png)
...
![connection-details](../../assets/source-datastores/managing-datastores/edit-datastore/connection-details-4.png)

**Step 3:** After editing the connection details, click on the **Test Connection** button to check and verify its connection.

![test](../../assets/source-datastores/managing-datastores/edit-datastore/test.png)
...
![save-datastore](../../assets/source-datastores/managing-datastores/edit-datastore/save-datastore-5.png)
