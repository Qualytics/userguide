...
![delete](../assets/source-datastores/datastore-settings/delete-datastore/delete-light-22.png)

**Step 2**: A modal window titled **Delete Datastore** will appear.

![delete-datastore](../assets/source-datastores/datastore-settings/delete-datastore/delete-datastore-light-23.png)
...
![confirm-delete](../assets/source-datastores/datastore-settings/delete-datastore/confirm-delete-light-24.png)
