...
![explore](../assets/explore/anomalies/explore-light.png)

**Step 2:** Click on the **"Anomalies"** from the Navigation Tab.

![anomalies](../assets/explore/anomalies/anomalies-light.png)
...
![all](../assets/explore/anomalies/all-anomalies-light.png)
...
![open](../assets/explore/anomalies/open-light.png)
...
![active](../assets/explore/anomalies/active-light.png)
...
![acknowledge](../assets/explore/anomalies/acknowledge-light.png)
...
![all](../assets/explore/anomalies/all-light.png)
...
![details](../assets/explore/anomalies/details-light.png)
...
![ackno](../assets/explore/anomalies/ackno-light.png)
...
![ackno-window](../assets/explore/anomalies/ackno-window-light.png)
...
![flash](../assets/explore/anomalies/flash-light.png)
...
![archived](../assets/explore/anomalies/archieve-ano-light.png)
...
![window](../assets/explore/anomalies/window-archive-light.png)
...
![button](../assets/explore/anomalies/archive-button-light.png)
...
![msg](../assets/explore/anomalies/msg-light.png)
...
![restore](../assets/explore/anomalies/restore-light.png)
...
![vertical](../assets/explore/anomalies/restore-button-light.png)

**Step 3:** After clicking on the **“Restore”** button, the selected anomaly is now restored as in acknowledged state.

![button](../assets/explore/anomalies/restored-light.png)
...
![sort](../assets/explore/anomalies/sort-light.png)
...
![caret](../assets/explore/anomalies/caret-light.png)
