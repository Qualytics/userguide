...
![observability-setting](../../assets/container/manage-tables-and-files/observability-settings/observability-light-18.png)
...
![observability-setting](../../assets/container/manage-tables-and-files/observability-settings/observability-light-19.png)
...
![allow-tracking](../../assets/container/manage-tables-and-files/observability-settings/tracking-light-20.png)

**Step 3:** Click on the **Save** button.

![save-button](../../assets/container/manage-tables-and-files/observability-settings/save-light-21.png)

After clicking on the Save button, a success flash message will appear stating **"Profile has been successfully updated"**.

![success-msg](../../assets/container/manage-tables-and-files/observability-settings/success-light-22.png)