...
![save-button](../../assets/container/manage-tables-and-files/settings-for-dfs-files-pattern/save-light-122.png)
...
![flash-message](../../assets/container/manage-tables-and-files/settings-for-dfs-files-pattern/success-light-133.png)