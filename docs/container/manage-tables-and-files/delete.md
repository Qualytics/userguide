...
**Delete** allows you to remove a table from the connected source datastore. While the table and its associated data will be deleted, it is not permanent, as the table can be recreated if you run a sync with the "recreate" option. 

!!! note
    Deleting a table is a reversible action if a sync with the "recreate" option is run later. 
...
![success-message](../../assets/container/manage-tables-and-files/delete/success-light-27.png)