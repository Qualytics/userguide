...
![export-button](../../assets/container/manage-tables-and-files/export/export-light-23.png)
...
For the next steps, detailed information on the Export Operation is available in the [Export Operation](../operations/export-operation.md){target="_blank"} section of the documentation.