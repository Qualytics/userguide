...
![materialize-button](../../assets/container/manage-tables-and-files/materialize/materialize-light-24.png)
...
For the next steps, detailed information on the Materialize Operation is available in the [Materialize Operation](../operations/materialize-operation.md){target="_blank"} section of the documentation.