...
### 🔎 If You Want to Search for Assets
...
- `Ctrl + K` (Windows/Linux) or `⌘ + K` (macOS)
...
> The Search shortcuts below are specifically for asset search and keyboard shortcut lookup. The top search bar (`Ctrl/⌘ + K`) is a Command Bar for navigation and actions.

The Search Shortcuts allow you to quickly find datastores, containers, fields, and view the complete list of shortcuts.

| Action | Windows/Linux | macOS |
|--------|--------------|--------|
| Search datastores, containers, and fields | Ctrl + Shift + F | ⌘ + Shift + F |
