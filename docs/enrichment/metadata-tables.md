...
!!! Note
	...
	For more detailed information on exporting metadata, please refer to the [export operation documentation](../container/enrichment-operation/export-operation.md)
