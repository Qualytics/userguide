...
![integrations-tab](../../../assets/integrations/alerting/slack/integrations-tab-light.png)
...
![connect](../../../assets/integrations/alerting/slack/connect-light.png)

A modal window titled **"Add Slack Integration"** appears. Fill in the connection properties to connect to Slack.

![add-slack-integration](../../../assets/integrations/alerting/slack/add-slack-integration-light.png)

**Step 2:**First, generate the access and refresh tokens through the Slack API by signing in.

![slack-sign-in](../../../assets/integrations/alerting/slack/slack-sign-in.png)

Alternatively, hover over the **?** icon and click on the **Go to Slack Tokens.**

![slack-hover](../../../assets/integrations/alerting/slack/slack-hover-light.png)
...
![tokens-light](../../../assets/integrations/alerting/slack/tokens-light.png)

**Step 3:**Fill out the copied connection properties of slack integration :

![add-tokens](../../../assets/integrations/alerting/slack/add-tokens-light.png)
...
![create-integration](../../../assets/integrations/alerting/slack/create-integration-light.png)
...
![created-successfully](../../../assets/integrations/alerting/slack/created-successfully-light.png)

**Step 5:**Click the **Authorize** button to complete the Slack integration using OAuth authentication.

![authorize](../../../assets/integrations/alerting/slack/authorize-light.png)
...
![allow-slack](../../../assets/integrations/alerting/slack/allow-slack.png)

A message appears confirming that the integration has been successfully authorized.

![authorized-successfully](../../../assets/integrations/alerting/slack/authorized-successfully-light.png)
...
![disconnect](../../../assets/integrations/alerting/slack/disconnect-light.png)

**Step 2:**A modal window **Disconnect Integration** will appear allowing you to disconnect the slack integration.

![disconnect-integration](../../../assets/integrations/alerting/slack/disconnect-integration-light.png)

**Step 3:**Click on the **Disconnect** button to proceed.

![disconnect-button](../../../assets/integrations/alerting/slack/disconnect-button-light.png)
...
![disconnected-successfully](../../../assets/integrations/alerting/slack/disconnected-successfully-light.png)
