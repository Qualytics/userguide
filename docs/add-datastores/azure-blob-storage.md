...
| REF | FIELD          | ACTION                                                                 |
|-----|----------------|------------------------------------------------------------------------|
| 1️.  | Name           | Specify the name of the datastore. Example: The specified name will appear on the datastore cards. |
...
| 3️.  | Connector      | Select **Azure Blob Storage** from the dropdown list.                   |
...
| REF | FIELD          | ACTION                                                                                                 |
|-----|----------------|--------------------------------------------------------------------------------------------------------|
| 1️.  | URI            | Enter the Uniform Resource Identifier (URI) of the Azure Blob Storage.                                |
| 2️.  | Account Name   | Input the account name to access the Azure Blob Storage.                                              |
| 3️.  | Access Key     | Input the access key provided for secure access.                                                      |
...
| 5️.  | Connector                             | Select a datastore connector as **Azure Blob Storage** from the dropdown list.                                                      |
