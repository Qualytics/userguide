...
![test-connection-for-existing-datastore](../assets/datastores/google-cloud-storage/test-connection-for-existing-datastore-light.png#only-light)
![test-connection-for-existing-datastore](../assets/datastores/google-cloud-storage/test-connection-for-existing-datastore-dark.png#only-dark)
...
![select-existing-enrichment-datastore](../assets/datastores/google-cloud-storage/select-existing-enrichment-datastore-light.png#only-light)
![select-existing-enrichment-datastore](../assets/datastores/google-cloud-storage/select-existing-enrichment-datastore-dark.png#only-dark)
