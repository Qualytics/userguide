...
![datastore](../assets/datastores/trino/datastore-light.png#only-light)
![datastore](../assets/datastores/trino/datastore-dark.png#only-dark)

**Step 2:** A modal window- Add Datastore will appear, providing you with the options to connect a datastore.

![connect](../assets/datastores/trino/connect-light.png#only-light)
![connect](../assets/datastores/trino/connect-dark.png#only-dark)
...
![select](../assets/datastores/trino/select-light.png#only-light)
![select](../assets/datastores/trino/select-dark.png#only-dark)
...
![secret](../assets/datastores/trino/secret-light.png#only-light)
![secret](../assets/datastores/trino/secret-dark.png#only-dark)

**Step 2**: The configuration form will expand, requesting credential details before establishing the connection.

![form](../assets/datastores/trino/form-light.png#only-light)
![form](../assets/datastores/trino/form-dark.png#only-dark)
...
| 5. | Catalog | Add a **Catalog** to fetch data structures and metadata from the Databricks. |
...
![test](../assets/datastores/trino/test-light.png#only-light)
![test](../assets/datastores/trino/test-dark.png#only-dark)
...
![existing](../assets/datastores/trino/existing-light.png#only-light)
![existing](../assets/datastores/trino/existing-dark.png#only-dark)
...
![testt](../assets/datastores/trino/testt-light.png#only-light)
![testt](../assets/datastores/trino/testt-dark.png#only-dark)
...
![next](../assets/datastores/trino/next-light.png#only-light)
![next](../assets/datastores/trino/next-dark.png#only-dark)

**Step 2**: A modal window- **Link Enrichment Datastore** will appear, providing you with the options to configure an **enrichment datastore**.

![window](../assets/datastores/trino/window-light.png#only-light)
![window](../assets/datastores/trino/window-dark.png#only-dark)
...
![caret](../assets/datastores/trino/caret-light.png#only-light)
![caret](../assets/datastores/trino/caret-dark.png#only-dark)

A modal window **Link Enrichment Datastore** will appear. Enter the following details to create an enrichment datastore with a new connection.

![windoww](../assets/datastores/trino/windoww-light.png#only-light)
![windoww](../assets/datastores/trino/windoww-dark.png#only-dark)
...
![selectedd](../assets/datastores/trino/selectedd-light.png#only-light)
![selectedd](../assets/datastores/trino/selectedd-dark.png#only-dark)
...
![testtt](../assets/datastores/trino/testtt-light.png#only-light)
![testtt](../assets/datastores/trino/testtt-dark.png#only-dark)

**Step 4**: Click on the **Finish** button to complete the configuration process.

![Finishh](../assets/datastores/trino/finish-light.png#only-light)
![Finishh](../assets/datastores/trino/finish-dark.png#only-dark)

When the configuration process is finished, a modal will display a **success message** indicating that **your datastore has been successfully added**.

![msg](../assets/datastores/trino/msg-light.png#only-light)
![msg](../assets/datastores/trino/msg-dark.png#only-dark)
...
![operation](../assets/datastores/trino/operation-light.png#only-light)
![operation](../assets/datastores/trino/operation-dark.png#only-dark)
...
![carett](../assets/datastores/trino/carett-light.png#only-light)
![carett](../assets/datastores/trino/carett-dark.png#only-dark)

**Step 2**: A modal window **Link Enrichment Datastore** will appear. Add a prefix name and select an existing enrichment datastore from the dropdown list.

![modall](../assets/datastores/trino/modall-light.png#only-light)
![modall](../assets/datastores/trino/modall-dark.png#only-dark)
...
![detail](../assets/datastores/trino/detail-light.png#only-light)
![detail](../assets/datastores/trino/detail-dark.png#only-dark)

**Step 4**: Click on the **Finish** button to complete the configuration process for the existing **enrichment datastore**.

![finishh](../assets/datastores/trino/finishh-light.png#only-light)
![finishh](../assets/datastores/trino/finishh-dark.png#only-dark)
