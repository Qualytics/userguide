...
![datastore](../assets/add-datastores/jdbc-datastores/trino/datastore.png)

**Step 2:** A modal window - **Add Datastore** will appear, providing you with the options to connect a datastore.

![connect](../assets/add-datastores/jdbc-datastores/trino/connect.png)
...
![select](../assets/add-datastores/jdbc-datastores/trino/select.png)
...
![secret](../assets/add-datastores/jdbc-datastores/trino/secret.png)

**Step 2**: The configuration form will expand, requesting credential details before establishing the connection.

![form](../assets/add-datastores/jdbc-datastores/trino/form.png)
...
![test](../assets/add-datastores/jdbc-datastores/trino/test.png)
...
![existing](../assets/add-datastores/jdbc-datastores/trino/existing.png)
...
![testt](../assets/add-datastores/jdbc-datastores/trino/testt.png)
...
![next](../assets/add-datastores/jdbc-datastores/trino/next.png)

**Step 2**: A modal window - **Link Enrichment Datastore** will appear, providing you with the options to configure an **enrichment datastore**.

![window](../assets/add-datastores/jdbc-datastores/trino/window.png)
...
![caret](../assets/add-datastores/jdbc-datastores/trino/caret.png)

A modal window **Link Enrichment Datastore** will appear. Enter the following details to create an enrichment datastore with a new connection.

![windoww](../assets/add-datastores/jdbc-datastores/trino/windoww.png)
...
![selectedd](../assets/add-datastores/jdbc-datastores/trino/selectedd.png)

**Step 3**: Click on the **Test Connection** button to verify the selected enrichment datastore connection. If the connection is verified, a flash message will indicate that the connection with the datastore has been successfully verified.

![testtt](../assets/add-datastores/jdbc-datastores/trino/testtt.png)

**Step 4**: Click on the **Finish** button to complete the configuration process.

![Finishh](../assets/add-datastores/jdbc-datastores/trino/finish.png)
...
![operation](../assets/add-datastores/jdbc-datastores/trino/operation.png)
...
![carett](../assets/add-datastores/jdbc-datastores/trino/carett.png)

**Step 2**: A modal window **Link Enrichment Datastore** will appear. Add a prefix name and select an existing enrichment datastore from the dropdown list.

![modall](../assets/add-datastores/jdbc-datastores/trino/modall.png)
...
![detail](../assets/add-datastores/jdbc-datastores/trino/detail.png)

**Step 4**: Click on the **Finish** button to complete the configuration process for the existing **enrichment datastore**.

![finishh](../assets/add-datastores/jdbc-datastores/trino/finishh.png)
