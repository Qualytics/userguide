...
![add-datastore](../assets/datastores/teradata/add-source-teradata-light-1.png#only-light)
![add-datastore](../assets/datastores/teradata/add-source-teradata-dark-1.png#only-dark)

**Step 2**: A modal window- **Add Datastore** will appear, providing you with the options to connect a datastore.

![add-datastore](../assets/datastores/teradata/add-teradata-connection-light-2.png#only-light)
![add-datastore](../assets/datastores/teradata/add-teradata-connection-dark-2.png#only-dark)
...
![add-datastore](../assets/datastores/teradata/add-connection-details-light-3.png#only-light)
![add-datastore](../assets/datastores/teradata/add-connection-details-dark-3.png#only-dark)

**Step 2**: The configuration form will expand, requesting credential details before establishing the connection.

![add-datastore](../assets/datastores/teradata/enter-teradata-details-light-4.png#only-light)
![add-datastore](../assets/datastores/teradata/enter-teradata-details-dark-4.png#only-dark)
...
![add-datastore](../assets/datastores/teradata/test-connection-success-new-light-5.png#only-light)
![add-datastore](../assets/datastores/teradata/test-connection-success-new-dark-5.png#only-dark)
...
![add-datastore](../assets/datastores/teradata/existing-connection-teradata-light-6.png#only-light)
![add-datastore](../assets/datastores/teradata/existing-connection-teradata-dark-6.png#only-dark)
...
![add-datastore](../assets/datastores/teradata/test-connection-success-existing-light-7.png#only-light)
![add-datastore](../assets/datastores/teradata/test-connection-success-existing-dark-7.png#only-dark)
!!! note
...
![add-datastore](../assets/datastores/teradata/enrichment-next-light-8.png#only-light)
![add-datastore](../assets/datastores/teradata/enrichment-next-dark-8.png#only-dark)
...
![add-datastore](../assets/datastores/teradata/add-enrichment-details-light-9.png#only-light)
![add-datastore](../assets/datastores/teradata/add-enrichment-details-dark-9.png#only-dark)
...
![add-datastore](../assets/datastores/teradata/enrichment-details-added-light-10.png#only-light)
![add-datastore](../assets/datastores/teradata/enrichment-details-added-dark-10.png#only-dark)
...
![add-datastore](../assets/datastores/teradata/test-enrichment-success-light-11.png#only-light)
![add-datastore](../assets/datastores/teradata/test-enrichment-success-dark-11.png#only-dark)

**Step 3**:  Click on the **Finish** button to complete the configuration process. 

![add-datastore](../assets/datastores/teradata/test-enrichment-finish-light-12.png#only-light)
![add-datastore](../assets/datastores/teradata/test-enrichment-finish-dark-12.png#only-dark)

When the configuration process is finished, a modal will display a **success message** indicating that **your datastore has been successfully added**.

![add-datastore](../assets/datastores/teradata/success-connection-teradata-light-13.png#only-light)
![add-datastore](../assets/datastores/teradata/success-connection-teradata-dark-13.png#only-dark)
...
![add-datastore](../assets/datastores/teradata/source-datastore-teradata-overview-light-14.png#only-light)
![add-datastore](../assets/datastores/teradata/source-datastore-teradata-overview-dark-14.png#only-dark)
...
![add-datastore](../assets/datastores/teradata/add-enrichment-details-existing-light-15.png#only-light)
![add-datastore](../assets/datastores/teradata/add-enrichment-details-existing-dark-15.png#only-dark)
...
![add-datastore](../assets/datastores/teradata/enrichment-details-check-light-16.png#only-light)
![add-datastore](../assets/datastores/teradata/enrichment-details-check-dark-16.png#only-dark)

**Step 3**: Click on the **Finish** button to complete the configuration process for the existing **enrichment datastore**.

![add-datastore](../assets/datastores/teradata/enrichment-details-finish-light-17.png#only-light)
![add-datastore](../assets/datastores/teradata/enrichment-details-finish-dark-17.png#only-dark)

When the configuration process is finished, a modal will display a **success message** indicating that **your data has been successfully added**.

![add-datastore](../assets/datastores/teradata/enrichment-details-success-light-18.png#only-light)
![add-datastore](../assets/datastores/teradata/enrichment-details-success-dark-18.png#only-dark)

Close the success message and you will be automatically redirected to the **Source Datastore Details** page where you can perform data operations on your configured **source datastore**.

![add-datastore](../assets/datastores/teradata/teradata-source-overview-light-19.png#only-light)
![add-datastore](../assets/datastores/teradata/teradata-source-overview-dark-19.png#only-dark)
