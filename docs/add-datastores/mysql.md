...
![hashcorp-explain](../assets/datastores/mysql/hashcorp-explain-light.png#only-light)
![hashcorp-explain](../assets/datastores/mysql/hashcorp-explain-dark.png#only-dark)
...
![carret-button](../assets/datastores/mysql/add-enrichment-light.png#only-light)
![carret-button](../assets/datastores/mysql/add-enrichment-dark.png#only-dark)
...
![modal-window](../assets/datastores/mysql/add-enrichment-detail-light.png#only-light)
