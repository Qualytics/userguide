...
**Step 1**: Select the **Redshift** connector from the dropdown list and add connection details such as port, host, password, database, and schema.
...
| 5️.   | Connector | Select a datastore connector as **Redshift** from the dropdown list. |

### Option I: Create an Enrichment Datastore with a new Connection

If the toggles for **Use an existing enrichment datastore** is off and **Add new connection** are turned on, then this will prompt you to add and configure the enrichment datastore from scratch without using an existing enrichment datastore and its connection details.
