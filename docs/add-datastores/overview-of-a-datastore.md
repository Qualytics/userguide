...
Qualytics connects to structured data systems using "Datastores," a framework that enables organizations to:
...
A Datastore in Qualytics represents any structured data system, such as:
...
| 3. | Connector | Select any datastore connector from the dropdown list. |
...
**Step 2:** After clicking on datastore, select the **"Activity"** tab to view the ongoing operation.
