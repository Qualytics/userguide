...
![carret-button](../assets/datastores/postgresql/add-enrichment-light.png#only-light)
![carret-button](../assets/datastores/postgresql/add-enrichment-dark.png#only-dark)
