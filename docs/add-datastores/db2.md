...
![add-datastore](../assets/add-datastores/jdbc-datastores/db2/add-datastore.png)

**Step 2:** A modal window- **Add Datastore** will appear, providing you with the options to connect a datastore.

![select-a-connector](../assets/add-datastores/jdbc-datastores/db2/select-a-connector.png)
...
![add-datastore-credentials](../assets/add-datastores/jdbc-datastores/db2/add-datastore-credentials.png)
...
![hashcorp-explain](../assets/add-datastores/jdbc-datastores/db2/hashcorp-explain.png)

**Step 2:** The configuration form will expand, requesting credential details before establishing the connection.

![add-datastore-credentials-explain](../assets/add-datastores/jdbc-datastores/db2/add-datastore-credentials-explain.png)
...
![test-datastore-connection](../assets/add-datastores/jdbc-datastores/db2/test-datastore-connection.png)
...
![use-existing-datastore](../assets/add-datastores/jdbc-datastores/db2/use-existing-datastore.png)
...
![test-connection-for-existing-datastore](../assets/add-datastores/jdbc-datastores/db2/test-connection-for-existing-datastore.png)
...
![next-button-for-enrichment](../assets/add-datastores/jdbc-datastores/db2/next-button-for-enrichment.png)

**Step 2:** A modal window- **Link Enrichment Datastore** will appear, providing you with the options to configure an **enrichment datastore**.

![select-enrichment-connector](../assets/add-datastores/jdbc-datastores/db2/select-enrichment-connector.png)
...
![caret-button](../assets/add-datastores/jdbc-datastores/db2/add-enrichment.png)

A modal window **Link Enrichment Datastore** will appear. Enter the following details to create an enrichment datastore with a new connection.

![modal-window](../assets/add-datastores/jdbc-datastores/db2/add-enrichment-details.png)
...
![modal-window](../assets/add-datastores/jdbc-datastores/db2/add-enrichment-detail.png)
...
![secret-management](../assets/add-datastores/jdbc-datastores/db2/secret-management.png)

**Step 3:** The configuration form, requesting credential details after selecting the **enrichment datastore** connector.

![enrichment-datastore-explain](../assets/add-datastores/jdbc-datastores/db2/enrichment-datastore-explain.png)
...
![test-connection-for-enrichment-datastore](../assets/add-datastores/jdbc-datastores/db2/test-connection-for-enrichment-datastore.png)

**Step 5:** Click on the **Finish** button to complete the configuration process. 

![finish-configuration](../assets/add-datastores/jdbc-datastores/db2/finish-configuration.png)
...
![data-operation-page](../assets/add-datastores/jdbc-datastores/db2/data-operation-page.png)
...
![use-enrichment-datastore](../assets/add-datastores/jdbc-datastores/db2/use-enrichment.png)

**Step 2**: A modal window **Link Enrichment Datastore** will appear. Add a prefix name and select an existing enrichment datastore from the dropdown list.

![select-existing-enrichment-datastore](../assets/add-datastores/jdbc-datastores/db2/select-existing-enrichment-datastore.png)
...
![use-existing-enrichment-datastore](../assets/add-datastores/jdbc-datastores/db2/use-existing-enrichment-datastore.png)

**Step 4:** Click on the **Finish** button to complete the configuration process for the existing **enrichment datastore**.

![finish-configuration-for-existing-enrichment-datastore](../assets/add-datastores/jdbc-datastores/db2/finish-configuration-for-existing-enrichment-datastore.png)
